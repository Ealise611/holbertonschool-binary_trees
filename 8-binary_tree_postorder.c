...
/**
 * binary_tree_posorder - Traverses a binary tree using posorder traversal
 *
...
void binary_tree_posorder(const binary_tree_t *tree, void (*func)(int))
{
	if (tree == NULL || func == NULL)
		return;
	binary_tree_posorder(tree->left, func);
	binary_tree_posorder(tree->right, func);
	func(tree->n);
}
